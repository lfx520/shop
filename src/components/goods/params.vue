    			...
    			<el-table :data="manyTableData" border stripe>
    				...
    				<el-table-column label="操作">
    					<template slot-scope="scope">
    						...
    						<el-button type="danger" icon="el-icon-delet" size="mini"@click="removeParams(scope.row.attr_id)">删除</el-button>
    					</template>
    				</el-table-column>
    			</el-table>
    		</el-tab-pane>
	...
	export default{
		...
		methods:{
			...
			async getParamsDate(){
				...
				//分割字符串，用三元表达式判断是否为空，然后用split分割成数组
